...
import { db, voteCollection, AppDocument } from "@/models/name";
...
const VoteButtons = ({
    ...
    id: string;
    upvotes: Models.DocumentList<AppDocument>;
    downvotes: Models.DocumentList<AppDocument>;
    className?: string;
}) => {
    const [votedDocument, setVotedDocument] = React.useState<AppDocument | null>(); // undefined means not fetched yet
