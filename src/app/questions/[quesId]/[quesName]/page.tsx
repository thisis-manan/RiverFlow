...
// Appwrite SDK responses are null-prototype objects, which React refuses to
// serialize across the server→client boundary. Deep-clone to plain objects.
    ...
    return (
        <TracingBeam className="container pl-6">
            ...
            <div className="relative mx-auto px-4 pb-20 pt-36">
                ...
                <div className="flex gap-4">
                    <div className="flex shrink-0 flex-col items-center gap-4">
                        <VoteButtons
                            ...
                            id={question.$id}
                            className="w-full"
                            upvotes={toPlain(upvotes)}
                            downvotes={toPlain(downvotes)}
                        />
                        <EditQuestion
                ...
                <Answers answers={toPlain(answers)} questionId={question.$id} />
            </div>
        </TracingBeam>
    );
};
