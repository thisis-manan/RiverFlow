...
import { AppDocument } from "@/models/name";
import { useRouter } from "next/navigation";
import React from "react";

const EditQues = ({ question }: { question: AppDocument }) => {
    ...
    React.useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps -- redirect non-owners once on mount
    }, []);
